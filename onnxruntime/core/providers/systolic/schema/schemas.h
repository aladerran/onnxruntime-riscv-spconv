...
//        fprintf(stderr, "CALLED INTO MAXPOOL SHAPE INFERENCE\n");
      ...
      .Input(4, "4", "input Nbmaps", "I", OpSchema::Optional, true, 1, OpSchema::NonDifferentiable)
      .Input(5, "5", "input Nbsizes", "I", OpSchema::Optional, true, 1, OpSchema::NonDifferentiable)
      .Input(6, "6", "input SizesIO", "I", OpSchema::Optional, true, 1, OpSchema::NonDifferentiable)
      .Input(7, "7", "input OutputCoords", "I", OpSchema::Optional, true, 1, OpSchema::NonDifferentiable)
      .Input(8, "8", "Bias", "T", OpSchema::Optional, true, 1, OpSchema::Differentiable)
